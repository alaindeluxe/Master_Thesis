...
int main(){
    ...
    for (int l=0; l<m; l++){
        ...
        for (int k=0; k<m; k++){
            ...
            if (l==k) {complement_intersection_graph[l].push_back(0);}
            else if (doIntersect(edge_i[l], edge_j[l], edge_i[k], edge_j[k])){
                complement_intersection_graph[l].push_back(0);
            } else {complement_intersection_graph[l].push_back(1);}
        }
    }
    ...
    sort(degree_complement_intersection_graph.begin(),degree_complement_intersection_graph.end(), myComparison);

    //for (int l=0; l<m; l++){
    //    cout << degree_complement_intersection_graph[l].first << " " << degree_complement_intersection_graph[l].second << "\n";
    //}
